...
export const isReferenceable = r => isDocument(r) || isNativeId(r)

export const isNativeId = n => DB().isNativeId(n)
...
export const isType = (value, type) => {
  ...
  else if (type.documentClass && type.documentClass() === 'document') return isDocument(value) || DB().isNativeId(value)
  else if (type.documentClass && type.documentClass() === 'embedded') return isEmbeddedDocument(value)
  else if (type === DB().nativeIdType()) return isNativeId(value)
